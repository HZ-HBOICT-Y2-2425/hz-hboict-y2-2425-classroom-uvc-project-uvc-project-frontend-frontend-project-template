...
<div class="flex flex-row items-center justify-center min-h-screen bg-gray-100">
    <section class="bg-white shadow-md rounded-lg p-8 w-full max-w-sm">
        ...
        <input id="user" placeholder="Gebruikersnaam of email" class="w-full px-4 py-2 mb-4 text-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none border {fields.user === "" ? 'border-red-500' : 'border-gray-300'}"/>
        
        <input id="password" type="password" placeholder="Wachtwoord" class="w-full px-4 py-2 mb-4 text-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none border {fields.password === "" ? 'border-red-500' : 'border-gray-300'}"/>
